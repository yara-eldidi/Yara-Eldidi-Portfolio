            ...
            <div className="relative group">
              ...
              <div className="relative p-2">
                <img
                  ...
                  className="w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full shadow-2xl object-cover transform group-hover:scale-105 transition-transform duration-700"
                  loading="eager"
                />
              </div>
